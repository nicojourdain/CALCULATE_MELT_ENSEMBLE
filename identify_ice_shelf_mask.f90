...
file_srf = '/store/njourd/DATA/DATA_BATHYMETRY/RTopo-2.0.1_30sec_surface_elevation_ANT3.nc'
file_bed = '/store/njourd/DATA/DATA_BATHYMETRY/RTopo-2.0.1_30sec_bedrock_topography_ANT3.nc'
file_msk = 'RTopo-2.0.1_30sec_ice_shelf_mask_ANT3.nc'
...
status = NF90_PUT_ATT(fidM,NF90_GLOBAL,"history","Created using identify_ice_shelf_mask.f90")
