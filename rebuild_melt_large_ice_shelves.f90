...
&          ii, jj, kstat, max_melt_pres_ID, min_melt_pres_ID
...
DO kk_tuning=1,nn_tuning
  ...
  DEALLOCATE( tmp_Futu_Melt, tmp_Pres_Melt, tmp_max_melt_pres, tmp_min_melt_pres )
