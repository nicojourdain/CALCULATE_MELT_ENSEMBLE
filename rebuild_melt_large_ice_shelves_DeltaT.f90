...
&                                    DeltaT, min_melt_pres, max_melt_pres
...
101 FORMAT('melt_ensemble_DeltaT_',i3.3,'_',i1,'.nc')
102 FORMAT('melt_ensemble_DeltaT_',i3.3,'_',i2,'.nc')
103 FORMAT('melt_ensemble_DeltaT_',i3.3,'.nc')
...
status = NF90_PUT_ATT(fidM,NF90_GLOBAL,"origin","Created using calculate_melt_rate_ensemble_DeltaT.f90"); call erreur(status,.TRUE.,"put_att_GLOBAL_ID")
status = NF90_PUT_ATT(fidM,NF90_GLOBAL,"history","Created using rebuild_melt_large_ice_shelves_DeltaT.f90"); call erreur(status,.TRUE.,"put_att_GLOBAL_ID")
